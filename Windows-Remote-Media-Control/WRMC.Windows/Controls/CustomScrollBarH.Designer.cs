...
namespace WRMC.Windows.Controls {
	partial class CustomScrollBarH {
		/// <summary> 
		...
		private void InitializeComponent() {
			...
			this.panelHandle.Size = new System.Drawing.Size(100, 12);
			...
			this.Name = "CustomScrollBarH";
			this.Size = new System.Drawing.Size(150, 12);
			this.MouseEnter += new System.EventHandler(this.CustomScrollBarH_MouseEnter);
			this.MouseLeave += new System.EventHandler(this.CustomScrollBarH_MouseLeave);
			this.Resize += new System.EventHandler(this.CustomScrollBarH_Resize);
